...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 p-0 m-0">
            <div class="card ">
                <div class="card-header bg-light"><h4>Doctor Information View</h4></div>
            ...
            <table class="table table-bordered table-hover table-striped table-responsive m-0">
				...
				foreach($data as $rows){
					...
					$id=$rows->id;
					echo "<td><a class=\"btn btn-info\" href=\"/admin/doctorinfoedit/$id\">Edit</a>  <a class=\"btn btn-danger\" href=\"/admin/delete/$id\">Delete</a></td>";
					echo "</tr>";
				}
				?>
                {{--        <tr>--}}
