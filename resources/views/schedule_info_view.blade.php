	...
	<div class="content">
		<div class="row">
			<div class="col-md-12 p-0 m-0">
				<div class="card ">
					<div class="card-header bg-light"><h4>Schedule Information View</h4></div>
				...
				?>
{{--				      <tr>--}}
{{--				          <td colspan="<?=$count;?>" class="text-center"><a href="/scheduleinfoform" class="btn btn-primary">Add New Schedule</a></td>--}}
{{--					    </tr>--}}
			</table>
		</div>
	</div>
